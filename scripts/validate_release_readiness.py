...
if progress.get("current_step") not in {19, 20}:
    errors.append("migration status must be on step 19 or 20")
if int(progress.get("last_completed_step", 0)) < 18:
    errors.append("step 18 must be completed")
